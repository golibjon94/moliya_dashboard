...
const tanlashBtn=(e)=>{
  e.preventDefault();
     ...
     return  item.districtID===financeInfos.districtID 
      && item.districtName===financeInfos.districtName
      && item.regionID===financeInfos.regionID 
      && item.regionName===financeInfos.regionName 
      && item.paymentYear===financeInfos.paymentYear 
      && item.paymentMonth===financeInfos.paymentMonth 
      && item.programmeID===financeInfos.programmeID 
   })
   :[];
   dispatch(getFilterData(filteredData))
}
  return <SvgButton onClick={tanlashBtn}>Ma'lumot olish</SvgButton>;
}
